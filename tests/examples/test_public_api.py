...
"""
from tests.examples.code import os_remove_wrap, process_and_zip
...
mocker.patch('tests.examples.code.os.remove', new=mock_remove)
"""
...
mocker.patch('tests.examples.code.zipfile.ZipFile', new=mock_ZipFile)
"""
...
"""
    ...
    # Arrange
    generated = mg.generate_uut_mocks_with_asserts(os_remove_wrap)
    ...
    assert (
        "mock_remove.assert_called_once_with('some/non/existing/path')"
